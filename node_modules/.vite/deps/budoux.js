...
var Parser = class {
   ...
   */
  constructor(model5) {
    this.model = new Map(Object.entries(model5).map(([k, v]) => [k, new Map(Object.entries(v))]));
...
var NodeOrText = class _NodeOrText {
...
var loadDefaultSimplifiedChineseParser = () => {
  return new HTMLProcessingParser(model2);
};
var loadDefaultTraditionalChineseParser = () => {
  return new HTMLProcessingParser(model3);
};
var loadDefaultThaiParser = () => {
  return new HTMLProcessingParser(model4);
};
var loadDefaultParsers = () => {
...
export {
  ...
  model2 as zhHansModel,
  model3 as zhHantModel
};
...
budoux/module/index.js:
   ...
   *)
*/
//# sourceMappingURL=budoux.js.map
